...
#ifndef SRC_MATHTOOL_TRI_TRI_H_
#define SRC_MATHTOOL_TRI_TRI_H_
...
*  points.  Each point is an array of two or three real_t precision
...
int tri_tri_overlap_test_3d(real_t p1[3], real_t q1[3], real_t r1[3],
          real_t p2[3], real_t q2[3], real_t r2[3]);


int coplanar_tri_tri3d(real_t  p1[3], real_t  q1[3], real_t  r1[3],
           real_t  p2[3], real_t  q2[3], real_t  r2[3],
           real_t  N1[3], real_t  N2[3]);


int tri_tri_overlap_test_2d(real_t p1[2], real_t q1[2], real_t r1[2],
          real_t p2[2], real_t q2[2], real_t r2[2]);


int tri_tri_intersection_test_3d(real_t p1[3], real_t q1[3], real_t r1[3],
         real_t p2[3], real_t q2[3], real_t r2[3],
         int * coplanar,
         real_t source[3],real_t target[3]);
...
int tri_tri_overlap_test_3d(real_t p1[3], real_t q1[3], real_t r1[3],
          ...
          real_t p2[3], real_t q2[3], real_t r2[3])
{
  real_t dp1, dq1, dr1, dp2, dq2, dr2;
  real_t v1[3], v2[3];
  real_t N1[3], N2[3];
...
int coplanar_tri_tri3d(real_t p1[3], real_t q1[3], real_t r1[3],
           real_t p2[3], real_t q2[3], real_t r2[3],
           real_t normal_1[3], real_t normal_2[3]){

  real_t P1[2],Q1[2],R1[2];
  real_t P2[2],Q2[2],R2[2];
...
{
  real_t dp1, dq1, dr1, dp2, dq2, dr2;
  real_t v1[3], v2[3], v[3];
  real_t N1[3], N2[3], N[3];
  real_t alpha;
...
int ccw_tri_tri_intersection_2d(real_t p1[2], real_t q1[2], real_t r1[2],
        real_t p2[2], real_t q2[2], real_t r2[2]) {
