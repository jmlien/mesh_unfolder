...
by Zhonghua Xi, George Mason University
yhao3@gmu.edu
...
The program unfolder allows you to generate a polyhedra
net for a given 3D mesh.
...
-- Report bugs to: Yue Hao yhao3@gmu.edu